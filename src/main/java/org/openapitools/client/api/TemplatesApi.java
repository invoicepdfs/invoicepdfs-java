...
public class TemplatesApi {
     ...
     */
    public okhttp3.Call previewTemplateApiV1TemplatesTemplateIdPreviewPostCall(String templateId, DocumentRenderRequest documentRenderRequest, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call previewTemplateApiV1TemplatesTemplateIdPreviewPostValidateBeforeCall(String templateId, DocumentRenderRequest documentRenderRequest, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'templateId' is set
        if (templateId == null) {
        ...
        if (documentRenderRequest == null) {
            throw new ApiException("Missing the required parameter 'documentRenderRequest' when calling previewTemplateApiV1TemplatesTemplateIdPreviewPost(Async)");
        }

        return previewTemplateApiV1TemplatesTemplateIdPreviewPostCall(templateId, documentRenderRequest, idempotencyKey, _callback);
     ...
     */
    public Object previewTemplateApiV1TemplatesTemplateIdPreviewPost(String templateId, DocumentRenderRequest documentRenderRequest, String idempotencyKey) throws ApiException {
        ApiResponse<Object> localVarResp = previewTemplateApiV1TemplatesTemplateIdPreviewPostWithHttpInfo(templateId, documentRenderRequest, idempotencyKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> previewTemplateApiV1TemplatesTemplateIdPreviewPostWithHttpInfo(String templateId, DocumentRenderRequest documentRenderRequest, String idempotencyKey) throws ApiException {
        okhttp3.Call localVarCall = previewTemplateApiV1TemplatesTemplateIdPreviewPostValidateBeforeCall(templateId, documentRenderRequest, idempotencyKey, null);
     ...
     */
    public okhttp3.Call previewTemplateApiV1TemplatesTemplateIdPreviewPostAsync(String templateId, DocumentRenderRequest documentRenderRequest, String idempotencyKey, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = previewTemplateApiV1TemplatesTemplateIdPreviewPostValidateBeforeCall(templateId, documentRenderRequest, idempotencyKey, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
